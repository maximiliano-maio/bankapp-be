package io.mngt.configurations.webservice;
...
public class WebServiceConfig extends WsConfigurerAdapter {
  ...
  public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema transactionsSchema) {
    ...
    wsdl11Definition.setTargetNamespace("http://mngt.io/services/transactions");
  ...
  public XsdSchema transactionsSchema() {
    return new SimpleXsdSchema(new ClassPathResource("TransactionService.xsd"));
  }
